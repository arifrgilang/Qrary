...
class DetailPeminjamRVAdapter(val npm: String, option: FirebaseRecyclerOptions<Book>)
    : FirebaseRecyclerAdapter<Book, DetailPeminjamRVAdapter.ViewHolder>(option) {
